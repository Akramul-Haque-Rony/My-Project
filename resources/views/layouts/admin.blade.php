        ...
        <div class="sidebar-wrapper sidebar-theme ">
            <nav id="sidebar">
                <div class="navbar-nav theme-brand flex-row  text-center">
                    @if (@Auth::user()->college_id > 0)
                        <div class="nav-logo">
                            <div class="nav-item theme-logo">
                                <a href="/">
                                    <img src="{{ @Auth::user()->CollegeInfo->CollegeDetailInfo->logo }}"
                                        alt="logo">
                                </a>
                            </div>
                    ...
                    @else
                        <div class="nav-logo">
                            ...
                            <div class="nav-item theme-text">
                                <a href="/" class="nav-link"> Admin P. </a>
                            </div>
                        </div>
                    @endif
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        <a href="{{ route('application2.foreign') }}/{{ @Auth::user()->college_id }}{{ @Auth::user()->CollegeInfo->short_name }}"
                            aria-expanded="" class="dropdown-toggle" target="_blank">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="NewStudent"
                            ...
                            @can('StudOfferLetter-list')
                                <li>
                                    <a href="{{ route('offerLetter.index') }}"> Offer Letter </a>
                                </li>
                            @endcan
                            @can('StudPaymentHistory-list')
                                <li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="newStudents"
                            ...
                            <li>
                                <a href="{{ route('portalStudent.view') }}" target="_blank"> Student Login (Portal)
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        <a href="{{ route('paymentHistory.index') }}" aria-expanded="" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="Associate" data-bs-parent="#accordionExample">
                            ...
                            @endcan
                            @can('Associate-report')
                                <li>
                                    <a href="{{ route('associate.report') }}"> Report </a>
                                </li>
                            @endcan
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="hr" data-bs-parent="#accordionExample">
                            <li>
                                <a href="{{ route('CompanyName.index') }}"> Company List </a>
                            </li>
                            <li>
                                <a href="{{ route('EmployeeDepartment.index') }}"> Department List </a>
                            </li>
                            <li>
                                <a href="{{ route('EmployeeDesignation.index') }}"> Designation List </a>
                            </li>
                            <li>
                                <a href="{{ route('employee.index') }}">Employee List
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="Settings" data-bs-parent="#accordionExample">
                            ...
                            @can('PaymentSchedule-list')
                                <li>
                                    <a href="{{ route('paymentSchedule.index') }}">Payment Schedule</a>
                                </li>
                            @endcan
                            @can('PaymentScheduleDetail-list')
                                <li>
