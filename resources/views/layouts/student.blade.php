...
<head>
    ...
    <link
        href="{{ asset('src/plugins/css/light/filepond/custom-filepond.css" rel="stylesheet" type="text/css') }}" />
    <link
        href="{{ asset('src/plugins/css/light/flatpickr/custom-flatpickr.css" rel="stylesheet" type="text/css') }}">
    <link href="{{ asset('src/assets/css/light/apps/invoice-add.css" rel="stylesheet" type="text/css') }}" />

    <link
        href="{{ asset('src/plugins/css/dark/filepond/custom-filepond.css" rel="stylesheet" type="text/css') }}" />
    <link
        href="{{ asset('src/plugins/css/dark/flatpickr/custom-flatpickr.css" rel="stylesheet" type="text/css') }}">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                        ...
                        {{-- <div class="dropdown-item">
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <a href="{{ route('portalStudent.logout') }}"
            ...
            <nav id="sidebar">
                <div class="navbar-nav theme-brand flex-row  text-center">
                    <div class="nav-logo">
                        <div class="nav-item theme-logo">
                            <a href="./index.html">
                                <img src="{{ asset('../src/assets/img/logo.svg') }}" alt="logo">
                            </a>
                        </div>
                        <div class="nav-item theme-text">
                            <a href="./index.html" class="nav-link"> TL </a>
                        </div>
                    </div>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu active">
                        <a href="{{ route('portalStudent.view') }}" aria-expanded="" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="users" data-bs-parent="#accordionExample">
                            <li>
                                <a href="{{ route('file.personalView') }}">Your File List</a>
                            </li>
                            <li>
            ...
            <div class="footer-wrapper">
                <div class="footer-section f-section-1">
                    <p class="">Copyright © <span class="dynamic-year">2022</span> <a target="_blank"
                            href="https://designreset.com/cork-admin/">TechnoLab</a>, All rights reserved.
                    </p>
                </div>
                <div class="footer-section f-section-2">
                    <p class="">Code with Rony<svg xmlns="http://www.w3.org/2000/svg" width="24"
