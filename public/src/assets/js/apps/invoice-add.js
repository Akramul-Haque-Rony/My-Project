...
document.getElementsByClassName('additem')[0].addEventListener('click', function () {
    ...
    $html = '<tr>' +
        ...
        '</ul>' +
        '</td>' +
        '<td class="description"><input type="text" class="form-control  form-control-sm"  placeholder="Subject Name" name="name[]"> <textarea class="form-control" placeholder="Books Refer" name="books_refer[]"></textarea></td>' +
        '<td class="rate">' +
        '<input type="text" class="form-control  form-control-sm" placeholder="credit count" name="cr_count[]">' +
        ' </td>' +
        '<td class="rate">' +
        '<input type="text" class="form-control  form-control-sm" placeholder="credit hour" name="cr_hour[]">' +
        ' </td>' +
        '<td class="rate">' +
        '<input type="text" class="form-control  form-control-sm" placeholder="sort no" name="sort_no[]">' +
        ' </td>' +               
        '<div class="n-chk">' +
