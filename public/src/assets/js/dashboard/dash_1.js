  ...
  try {
    ...
    if (ParsedObject.settings.layout.darkMode) {
      ...
      */
      ...
      xaxis: {
          categories: ['233022', '2023', '2024', '2025', '2026', '2027', '2028', '2029', '2030', '2031', '2032', '2035'],
      },
      fill: {
        type: 'gradient',
        gradient: {
...
// {{$bb}}
      ...
      var nnnn = '<?php echo "fffffffffff"; ?>';
      var categLine = $('.session1').val();
      var label1Data = $('.label1Data').val();
      // this.alert(label1Data)
      var label2Data = $('.label2Data').val();
